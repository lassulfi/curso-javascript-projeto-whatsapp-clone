...
export class Message extends Model {
    ...
    getViewElement(currentUser = true) {
        ...
        //Check whether the user is sending the message {message-out} or recieving the 
        //message {message-in}
    ...
    static sendImage(chatId, from, file) {
        return new Promise((resolve, reject) => {
            Message.upload(file, from).then(snapshot => {
                //TODO: Corrigir metodo para recuperar URL.
    ...
    static send(chatId, from, type, content) {
        return new Promise((resolve, reject) => {
            Message.getDatabaseReference(chatId).add({
                content, 
                timestamp: new Date(),
                status: 'wait',
                type,
    ...
    static getDatabaseReference(chatId) {
